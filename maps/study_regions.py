...
cbar = plt.colorbar()
CS1 = m.contour(lons,lats,np.squeeze(bath),[0.5], colors='k', latlon=True, linestyles='solid', alpha=0.9)
CS2 = m.contour(lons,lats,np.squeeze(bath),[4], colors='k', latlon=True, linestyles='solid', alpha=0.9)
